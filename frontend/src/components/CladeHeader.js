...
const CladeHeader = ({ expandGroup, isExpanded, setIsExpanded, cladeName, cladeType, hoverColor }) => {
    ...
    return (
        <section
            ...
            onClick={e => expandGroup(e.currentTarget.parentElement, isExpanded, setIsExpanded)}
